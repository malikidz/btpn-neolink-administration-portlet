...
PerijinanBI parameter = (PerijinanBI) row.getObject();
long groupId = themeDisplay.getLayout().getGroupId();
String name = PerijinanBI.class.getName();
...
<liferay-ui:icon-menu cssClass="">
	<%
		...
		portletURL.setParameter("tabs2", Constants.TAB_PERIJINAN_BI);
	...
	<%
		...
		deleteURL.setParameter("javax.portlet.action", "deletePerijinanBI");
	%>
