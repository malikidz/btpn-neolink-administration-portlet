...
InvestStandardBI parameter = (InvestStandardBI) row.getObject();
long groupId = themeDisplay.getLayout().getGroupId();
String name = InvestStandardBI.class.getName();
...
<liferay-ui:icon-menu cssClass="">
	<%
		...
		portletURL.setParameter("tabs1", Constants.TAB_INVEST_STANDARD_BI);
	...
	<%
		...
		deleteURL.setParameter("javax.portlet.action", "deleteinvestStandardBI");
	%>
