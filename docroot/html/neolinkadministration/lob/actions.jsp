...
LineOfBusiness parameter = (LineOfBusiness) row.getObject();
long groupId = themeDisplay.getLayout().getGroupId();
String name = LineOfBusiness.class.getName();
...
<liferay-ui:icon-menu cssClass="">
	<%
		...
		portletURL.setParameter("tabs1", Constants.TAB_LOB);
	...
	<%
		...
		deleteURL.setParameter("javax.portlet.action", "deleteLOB");
	%>
