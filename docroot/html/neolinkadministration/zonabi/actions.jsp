...
ZonaBI parameter = (ZonaBI) row.getObject();
long groupId = themeDisplay.getLayout().getGroupId();
String name = ZonaBI.class.getName();
...
<liferay-ui:icon-menu cssClass="">
	<%
		...
		portletURL.setParameter("tabs1", Constants.TAB_ZONA_BI);
	...
	<%
		...
		deleteURL.setParameter("javax.portlet.action", "deleteZonaBI");
	%>
