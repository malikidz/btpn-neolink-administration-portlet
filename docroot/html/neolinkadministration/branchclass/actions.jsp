...
BranchClass parameter = (BranchClass) row.getObject();
long groupId = themeDisplay.getLayout().getGroupId();
String name = BranchClass.class.getName();
...
<liferay-ui:icon-menu cssClass="">
	<%
		...
		portletURL.setParameter("tabs1", Constants.TAB_BRANCH_CLASS);
	...
	<%
		...
		deleteURL.setParameter("javax.portlet.action", "deleteBranchClass");
	%>
