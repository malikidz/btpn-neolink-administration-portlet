...
EmailScheduler parameter = (EmailScheduler) row.getObject();
long groupId = themeDisplay.getLayout().getGroupId();
String name = EmailScheduler.class.getName();
...
<liferay-ui:icon-menu cssClass="">
	<%
		...
		portletURL.setParameter("tabs1", Constants.TAB_EMAIL_SCHEDULER);
	...
	<%
		...
		deleteURL.setParameter("javax.portlet.action", "deleteEmailScheduler");
	%>
